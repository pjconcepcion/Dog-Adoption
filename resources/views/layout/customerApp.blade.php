...
@yield('content')
    ...
    <script src={{URL::asset("customer/js/jquery-3.2.1.min.js")}}></script>
    <script src={{URL::asset("customer/js/popper.min.js")}}></script>
    <script src={{URL::asset("customer/js/bootstrap.min.js")}}></script>
    <script src={{URL::asset("customer/js/owl.carousel.min.js")}}></script>
    <script src={{URL::asset("customer/js/jquery.waypoints.min.js")}}></script>
    <script src={{URL::asset("customer/js/main.js")}}></script>
    <script> 
