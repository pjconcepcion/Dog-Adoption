...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="adopt/customer/css/bootstrap.css">
        <link rel="stylesheet" href="adopt/customer/css/animate.css">
        <link rel="stylesheet" href="adopt/customer/css/owl.carousel.min.css">
        <link rel="stylesheet" href="adopt/customer/fonts/ionicons/css/ionicons.min.css">
        <link rel="stylesheet" href="adopt/customer/fonts/fontawesome/css/font-awesome.min.css">
      
        {{-- <link rel="stylesheet" href="adopt/customer/fonts/flaticon/font/flaticon.css"> --}}

        <!-- Theme Style -->
        <link rel="stylesheet" href="adopt/customer/css/style.css">
    </head>
...
<footer class="site-footer" role="contentinfo">
  ...
  <script src="adopt/customer/js/jquery-3.2.1.min.js"></script>
  <script src="adopt/customer/js/popper.min.js"></script>
  <script src="adopt/customer/js/bootstrap.min.js"></script>
  <script src="adopt/customer/js/owl.carousel.min.js"></script>
  <script src="adopt/customer/js/jquery.waypoints.min.js"></script>
  <script src="adopt/customer/js/main.js"></script>
  <script> 
